...
#>    <chr>                         <chr>                                                                          <chr> <chr>         <chr>                
#>  1 ELEC.CONS_TOT_BTU.COW-AK-98.A Total consumption (Btu) : coal : Alaska : electric power (total) : annual      A     million MMBtu 23-OCT-19 06.58.10 PM
#>  2 ELEC.CONS_TOT_BTU.COW-AK-98.M Total consumption (Btu) : coal : Alaska : electric power (total) : monthly     M     million MMBtu 13-NOV-19 04.22.41 PM
#>  3 ELEC.CONS_TOT_BTU.COW-AK-98.Q Total consumption (Btu) : coal : Alaska : electric power (total) : quarterly   Q     million MMBtu 13-NOV-19 04.22.41 PM
#>  4 ELEC.CONS_TOT_BTU.COW-AL-98.A Total consumption (Btu) : coal : Alabama : electric power (total) : annual     A     million MMBtu 23-OCT-19 06.58.10 PM
#>  5 ELEC.CONS_TOT_BTU.COW-AL-98.M Total consumption (Btu) : coal : Alabama : electric power (total) : monthly    M     million MMBtu 13-NOV-19 04.22.41 PM
#>  6 ELEC.CONS_TOT_BTU.COW-AL-98.Q Total consumption (Btu) : coal : Alabama : electric power (total) : quarterly  Q     million MMBtu 13-NOV-19 04.22.41 PM
#>  7 ELEC.CONS_TOT_BTU.COW-AR-98.A Total consumption (Btu) : coal : Arkansas : electric power (total) : annual    A     million MMBtu 23-OCT-19 06.58.10 PM
#>  8 ELEC.CONS_TOT_BTU.COW-AR-98.M Total consumption (Btu) : coal : Arkansas : electric power (total) : monthly   M     million MMBtu 13-NOV-19 04.22.41 PM
#>  9 ELEC.CONS_TOT_BTU.COW-AR-98.Q Total consumption (Btu) : coal : Arkansas : electric power (total) : quarterly Q     million MMBtu 13-NOV-19 04.22.41 PM
#> 10 ELEC.CONS_TOT_BTU.COW-AZ-98.A Total consumption (Btu) : coal : Arizona : electric power (total) : annual     A     million MMBtu 23-OCT-19 06.58.10 PM
#> # ... with 164 more rows
```
...
#>   value date        year
#>   <dbl> <date>     <int>
#> 1 10.4  2018-01-01  2018
#> 2  9.21 2017-01-01  2017
#> 3  9.64 2016-01-01  2016

select(x1, series_id, data) %>% unnest(cols = data)
#> # A tibble: 3 x 4
#>   series_id                     value date        year
#>   <chr>                         <dbl> <date>     <int>
#> 1 ELEC.CONS_TOT_BTU.COW-AK-98.A 10.4  2018-01-01  2018
#> 2 ELEC.CONS_TOT_BTU.COW-AK-98.A  9.21 2017-01-01  2017
#> 3 ELEC.CONS_TOT_BTU.COW-AK-98.A  9.64 2016-01-01  2016
...
#>   <dbl> <date>     <int> <int>
#> 1 0.854 2019-08-01  2019     8
#> 2 0.852 2019-07-01  2019     7
#> 3 0.771 2019-06-01  2019     6
x3$data[[1]]
#> # A tibble: 3 x 4
#>   value date        year   qtr
#>   <dbl> <date>     <int> <int>
#> 1 NA    2019-04-01  2019     2
#> 2  3.01 2019-01-01  2019     1
#> 3  3.16 2018-10-01  2018     4
```
...
#> 1 ELEC.CONS_TOT_~ Total consumption (Btu) ~ million~ A     "Summation of all types of coal; Powe~ None      EIA, U.S. Ener~ USA-AK  USA-AK    2001  2018  2019-10-23~ <tibbl~
#> 2 ELEC.CONS_TOT_~ Total consumption (Btu) ~ million~ M     "Summation of all types of coal; Powe~ None      EIA, U.S. Ener~ USA-AK  USA-AK    2001~ 2019~ 2019-11-13~ <tibbl~
#> 3 ELEC.CONS_TOT_~ Total consumption (Btu) ~ million~ Q     "Summation of all types of coal; Powe~ None      EIA, U.S. Ener~ USA-AK  USA-AK    2001~ 2019~ 2019-11-13~ <tibbl~
```
...
#> 1 ELEC.CONS_TOT_BTU.COW-AK-98.A 10.4   2018-01-01  2018    NA    NA
#> 2 ELEC.CONS_TOT_BTU.COW-AK-98.A  9.21  2017-01-01  2017    NA    NA
#> 3 ELEC.CONS_TOT_BTU.COW-AK-98.A  9.64  2016-01-01  2016    NA    NA
#> 4 ELEC.CONS_TOT_BTU.COW-AK-98.M  0.854 2019-08-01  2019     8    NA
#> 5 ELEC.CONS_TOT_BTU.COW-AK-98.M  0.852 2019-07-01  2019     7    NA
#> 6 ELEC.CONS_TOT_BTU.COW-AK-98.M  0.771 2019-06-01  2019     6    NA
#> 7 ELEC.CONS_TOT_BTU.COW-AK-98.Q NA     2019-04-01  2019    NA     2
#> 8 ELEC.CONS_TOT_BTU.COW-AK-98.Q  3.01  2019-01-01  2019    NA     1
#> 9 ELEC.CONS_TOT_BTU.COW-AK-98.Q  3.16  2018-10-01  2018    NA     4
```
...
#> 1    USA-AK   2001   2018 2019-10-23T18:58:10-0400      2018, 2017, 2016, 10.37727, 9.21412, 9.64353
#> 2    USA-AK 200101 201908 2019-11-13T16:22:41-0500 201908, 201907, 201906, 0.85395, 0.85228, 0.77063
#> 3    USA-AK 2001Q1 2019Q2 2019-11-13T16:22:41-0500      2019Q2, 2019Q1, 2018Q4, NA, 3.00949, 3.16491
```
...
#> {"request":{"command":"series","series_id":"ELEC.CONS_TOT_BTU.COW-AK-98.A;ELEC.CONS_TOT_BTU.COW-AK-98.M;ELEC.CONS_TOT_BTU.COW-AK-98.Q"},"series":[{"series_id":"ELEC.CONS_TOT_BTU.COW-AK-98.A","name":"Total consumption (Btu) : coal : Alaska : electric power (total) : annual","units":"million MMBtu","f":"A","description":"Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; ","copyright":"None","source":"EIA, U.S. Energy Information Administration","iso3166":"USA-AK","geography":"USA-AK","start":"2001","end":"2018","updated":"2019-10-23T18:58:10-0400","data":[["2018",10.37727],["2017",9.21412],["2016",9.64353]]},{"series_id":"ELEC.CONS_TOT_BTU.COW-AK-98.M","name":"Total consumption (Btu) : coal : Alaska : electric power (total) : monthly","units":"million MMBtu","f":"M","description":"Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; ","copyright":"None","source":"EIA, U.S. Energy Information Administration","iso3166":"USA-AK","geography":"USA-AK","start":"200101","end":"201908","updated":"2019-11-13T16:22:41-0500","data":[["201908",0.85395],["201907",0.85228],["201906",0.77063]]},{"series_id":"ELEC.CONS_TOT_BTU.COW-AK-98.Q","name":"Total consumption (Btu) : coal : Alaska : electric power (total) : quarterly","units":"million MMBtu","f":"Q","description":"Summation of all types of coal; Power plants owned by companies whose primary purpose is to produce power; ","copyright":"None","source":"EIA, U.S. Energy Information Administration","iso3166":"USA-AK","geography":"USA-AK","start":"2001Q1","end":"2019Q2","updated":"2019-11-13T16:22:41-0500","data":[["2019Q2",null],["2019Q1",3.00949],["2018Q4",3.16491]]}]}
```
...
#> 1 ELEC.CONS_TOT_B~ Total consumption (Btu) : ~ million~ A     "Summation of all types of coal; Power ~ None      EIA, U.S. Energy~ USA-AK  USA-AK    2001  2018  2019-10-23T~
#> 2 ELEC.CONS_TOT_B~ Total consumption (Btu) : ~ million~ M     "Summation of all types of coal; Power ~ None      EIA, U.S. Energy~ USA-AK  USA-AK    2001~ 2019~ 2019-11-13T~
#> 3 ELEC.CONS_TOT_B~ Total consumption (Btu) : ~ million~ Q     "Summation of all types of coal; Power ~ None      EIA, U.S. Energy~ USA-AK  USA-AK    2001~ 2019~ 2019-11-13T~
eia_series_updates(id)
#> # A tibble: 3 x 2
#>   series_id                     updated                 
#>   <chr>                         <chr>                   
#> 1 ELEC.CONS_TOT_BTU.COW-AK-98.A 2019-10-23T18:58:10-0400
#> 2 ELEC.CONS_TOT_BTU.COW-AK-98.M 2019-11-13T16:22:41-0500
#> 3 ELEC.CONS_TOT_BTU.COW-AK-98.Q 2019-11-13T16:22:41-0500
eia_series_dates(id)
#> # A tibble: 316 x 4
...
#> 1 ELEC.CONS_TOT_BTU.COW-AK-98.A 2001-01-01 2018-01-01 2001   2018   A              18
#> 2 ELEC.CONS_TOT_BTU.COW-AK-98.M 2001-01-01 2019-08-01 200101 201908 M             224
#> 3 ELEC.CONS_TOT_BTU.COW-AK-98.Q 2001-01-01 2019-04-01 2001Q1 2019Q2 Q              74
eia_series_cats(id)
#> # A tibble: 6 x 3
...
#>   series_id                    updated                 
#>   <chr>                        <chr>                   
#> 1 ELEC.CONS_TOT_BTU.COW-AK-1.M 2019-11-13T16:22:41-0500
#> 2 ELEC.CONS_TOT_BTU.COW-AK-1.Q 2019-11-13T16:22:41-0500
#> 3 ELEC.CONS_TOT_BTU.COW-AL-1.M 2019-11-13T16:22:41-0500
#> 4 ELEC.CONS_TOT_BTU.COW-AL-1.Q 2019-11-13T16:22:41-0500
#> 5 ELEC.CONS_TOT_BTU.COW-AR-1.M 2019-11-13T16:22:41-0500
```
