...
#> 1 ELEC.GEN.ALL-9~ Net generation : all fuels : all s~ A     thousand megaw~ ELEC.GEN.ALL-CA~ Net generation : all fuels : California ~ USA-CA <NA>   2001  2018  <tibble [3 ~
```
...
#>   geoset_id       setname                            f     units            series_id        name                                       region latlon start end   data       
#>   <chr>           <chr>                              <chr> <chr>            <chr>            <chr>                                      <chr>  <chr>  <chr> <chr> <list>     
#> 1 ELEC.GEN.ALL-9~ Net generation : all fuels : all ~ A     thousand megawa~ ELEC.GEN.ALL-AK~ Net generation : all fuels : Alaska : all~ USA-AK <NA>   2001  2018  <tibble [1~
#> 2 ELEC.GEN.ALL-9~ Net generation : all fuels : all ~ A     thousand megawa~ ELEC.GEN.ALL-CT~ Net generation : all fuels : Connecticut ~ USA-CT <NA>   2001  2018  <tibble [1~
#> 3 ELEC.GEN.ALL-9~ Net generation : all fuels : all ~ A     thousand megawa~ ELEC.GEN.ALL-MA~ Net generation : all fuels : Massachusett~ USA-MA <NA>   2001  2018  <tibble [1~
#> 4 ELEC.GEN.ALL-9~ Net generation : all fuels : all ~ A     thousand megawa~ ELEC.GEN.ALL-ME~ Net generation : all fuels : Maine : all ~ USA-ME <NA>   2001  2018  <tibble [1~
#> 5 ELEC.GEN.ALL-9~ Net generation : all fuels : all ~ A     thousand megawa~ ELEC.GEN.ALL-NH~ Net generation : all fuels : New Hampshir~ USA-NH <NA>   2001  2018  <tibble [1~
#> 6 ELEC.GEN.ALL-9~ Net generation : all fuels : all ~ A     thousand megawa~ ELEC.GEN.ALL-RI~ Net generation : all fuels : Rhode Island~ USA-RI <NA>   2001  2018  <tibble [1~
#> 7 ELEC.GEN.ALL-9~ Net generation : all fuels : all ~ A     thousand megawa~ ELEC.GEN.ALL-VT~ Net generation : all fuels : Vermont : al~ USA-VT <NA>   2001  2018  <tibble [1~
x$data[[1]]
#> # A tibble: 1 x 3
#>   value date        year
#>   <dbl> <date>     <int>
...
#>    <chr>   <dbl> <date>     <int>
#>  1 USA-NJ 75034. 2018-01-01  2018
#>  2 USA-NJ 75645. 2017-01-01  2017
#>  3 USA-NJ 77611. 2016-01-01  2016
#>  4 USA-NJ 74609. 2015-01-01  2015
#>  5 USA-NJ 68051. 2014-01-01  2014
#>  6 USA-NJ 64751. 2013-01-01  2013
#>  7 USA-NJ 65263. 2012-01-01  2012
#>  8 USA-NJ 64694. 2011-01-01  2011
#>  9 USA-NJ 65682. 2010-01-01  2010
#> 10 USA-NJ 61811. 2009-01-01  2009
#> # ... with 26 more rows
